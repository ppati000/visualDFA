...
/**
 * A {@code ConstantFoldingElement} is a {@code LatticeElement} used by
 * {@code ConstantFoldingAnalysis}. 
 *
 * @author Nils Jessen
...
public class ConstantFoldingElement extends LocalMapElement<Value> {
	...
	/**
	 * Determines whether a certain type of Local is accepted (can be contained in)
	 * a {@code ConstantFoldingElement}.
	 * 
	 * @param type
	 *            the {@code Type} in question
	 * @return {@code true} if the given {@code Type} is accepted, {@code false}
	 *         otherwise
	 */
	...
	/**
	 * Creates a {@code LocalMapElement} with the given mapping and
	 * local-{@code Comparator}.
	 * 
	 * @param localMap
	 *            a {@code Map} that maps a {@code JimpleLocal} to its corresponding
	 *            value
	 */
	...
	public static class Value {
		...
		/**
		 * Returns the {@code ArithmeticConstant} represented by this {@code Value} or
		 * {@code null} if no constant.
		 * 
		 * @return the {@code ArithmeticConstant} represented by this {@code Value} or
		 *         {@code null} if no constant
		 */
