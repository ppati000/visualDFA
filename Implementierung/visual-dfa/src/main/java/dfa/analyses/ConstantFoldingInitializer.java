...
/**
 * A {@code ConstantFoldingInitializer} performs the initialization for a
...
public class ConstantFoldingInitializer implements Initializer<ConstantFoldingElement> {
	...
	/**
	 * Creates a {@code ConstantFoldingInitializer} for the given
	...
	public ConstantFoldingInitializer(SimpleBlockGraph blockGraph) {
		...
		BlockState<ConstantFoldingElement> defaultState = new BlockState<ConstantFoldingElement>(defaultInOut,
				defaultInOut);
