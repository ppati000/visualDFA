...
/**
 * A {@code ConstantFoldingTransition} performs the transition for a
...
public class ConstantFoldingTransition implements Transition<ConstantFoldingElement> {
	...
	static class Transitioner implements StmtSwitch {
		...
		/**
		 * Creates a {@code Transitioner} with the given
		 * input-{@code ConstantFoldingElement}.
		 * 
		 * @param inputElement
	 ...
	 * @author Sebastian Rauch
	 * 
	 *         A {@code Evaluator} evaluates {@code JimpleValue}s (e. g.
	 *         {@code soot.jimple.Expr}).
	 */
	static class Evaluator implements JimpleValueSwitch {
		...
		/**
		 * Creates a new {@code Evaluator} with the given
		 * input-{@code ConstantFoldingElement}.
		 * 
		 * @param inputElement
		 *            the input for this {@code Evaluator}, on which the evaluation is
		 *            based on
		 */
	 ...
	 * @author Sebastian Rauch
	 * 
	 *         Retrieves the (numeric) values of {@code IntConstant}s or
	 *         {@code LongConstant}s.
	 *
	 */
