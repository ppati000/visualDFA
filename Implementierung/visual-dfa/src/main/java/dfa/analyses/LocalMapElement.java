...
/**
 * A {@code LocalMapElement} is a {@code LatticeElement} that maps each
 * {@code JimpleLocal} to a value of type {@code V}. 
 *
 * @param <V>
 *            the type of value
 * 
...
public abstract class LocalMapElement<V> implements LatticeElement, Cloneable {
	...
	/**
	 * Returns a {@code Map} that maps a {@code JimpleLocal} to its corresponding
	 * value.
	 * 
	 * @return a {@code Map} that maps a {@code JimpleLocal} to its corresponding
	 *         value
	 */
	...
	/*
	 * force subclasses to override this themselves (to make sure the
	 * equals-hashCode-contract is fulfilled)
	 */
	@Override
