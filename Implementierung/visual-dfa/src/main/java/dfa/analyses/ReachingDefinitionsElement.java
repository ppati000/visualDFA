...
/**
 * A {@code ReachingDefinitionsElement} is a {@code LatticeElement} used by
...
public class ReachingDefinitionsElement extends LocalMapElement<DefinitionSet> {
	 ...
	 * @author Nils Jessen
	 * 
	 *         A {@code StringRepresentation} evaluates {@code JimpleValue}s (e. g.
	...
	static class StringRepresentation implements JimpleValueSwitch {
		...
		/**
		 * Creates a new {@code StringRepresentation} with the given
		 * input-{@code ReachingDefinitionsElement}.
		 * 
		 * @param inputDefinition
		 *            the input for this {@code StringRepresentaton}, on which the
