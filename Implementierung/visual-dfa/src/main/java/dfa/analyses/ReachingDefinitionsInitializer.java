...
public class ReachingDefinitionsInitializer implements Initializer<ReachingDefinitionsElement> {
	...
	/**
	 * Creates a {@code ReachingDefinitionsInitializer} for the given
	 * {@code SimpleBlockGraph}.
	 * 
	 * @param blockGraph
	 *            the {@code SimpleBlockGraph} the analysis to initialize is
	 *            executed on
	 */
	...
	public Map<Block, BlockState<ReachingDefinitionsElement>> getInitialStates() {
		...
		Map<JimpleLocal, ReachingDefinitionsElement.DefinitionSet> initialBottomMap = new TreeMap<>(
		...
		BlockState<ReachingDefinitionsElement> defaultState = new BlockState<ReachingDefinitionsElement>(defaultIn,
				defaultIn);

		Map<Block, BlockState<ReachingDefinitionsElement>> initialMap = new HashMap<Block, BlockState<ReachingDefinitionsElement>>();
