...
/**
 * A {@code DataFlowAnalysis} provides operations needed for dataflow-analysis. Specifically it provides methods to
 * perform joins and transitions as well as initialize the states of all basic-blocks.
 *
 * @param <E>
