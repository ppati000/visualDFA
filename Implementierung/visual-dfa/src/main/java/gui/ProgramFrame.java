...
public class ProgramFrame extends JFrame {
	 ...
	 * 
	 * @param ctrl The controller to which the actionListeners will correspond.
	 * 
	 * @see Controller
	...
	/**
	 * This method will switch between the StatePanelOpen and the StatePanelClosed.
	 * Only one of them will be shown at a time.
	 * 
	 * @see StatePanelOpen
