...
public class TestTransition01 {
    ...
    public void testAllConstant() {
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "one", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "x", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "y", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "z", aliasMap, currentCfe);
        ...
        currentCfe = cfe02;
        TestUtils.assertLocalValue(TestUtils.getIntValue(1), "one", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "x", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "y", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "z", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(1), "one", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "x", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(4), "y", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "z", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "x", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(4), "y", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(4), "z", aliasMap, currentCfe);
        
        ConstantFoldingElement cfe06 = cfTransition.transition(cfe05, units.get(5));
        currentCfe = cfe06;
        TestUtils.assertLocalValue(TestUtils.getIntValue(1), "one", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(16), "x", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(4), "y", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(4), "z", aliasMap, currentCfe);
    ...
    public void testAllConstantConflict() {
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(1), "one", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(17), "x", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "y", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "z", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(1), "one", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(1), "x", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "y", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "z", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(1), "one", aliasMap, currentCfe);
        TestUtils.assertLocalValue(Value.getTop(), "x", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "y", aliasMap, currentCfe);        // here 0 * TOP should be 0
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "z", aliasMap, currentCfe);
    ...
    public void testNonConstant() {
        ...
        ConstantFoldingElement currentCfe = initInStateStartBlock;
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "p", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "one", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "x", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "y", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "$i0", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(Value.getTop(), "x", aliasMap, currentCfe);      
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "y", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "$i0", aliasMap, currentCfe);      // 0 * TOP = 0
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(1), "one", aliasMap, currentCfe);
        TestUtils.assertLocalValue(Value.getTop(), "x", aliasMap, currentCfe);      
        TestUtils.assertLocalValue(TestUtils.getIntValue(5), "y", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "$i0", aliasMap, currentCfe);
    ...
    public void testIntArithmetic() {
        ...
        ConstantFoldingElement currentCfe = initInStateStartBlock;
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "top", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "one", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "zero", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "d", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "r", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(1), "one", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "zero", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(-17433), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "d", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "r", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "zero", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(-17433), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(100), "d", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "r", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(-17433), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(100), "d", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(-17333), "r", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(-17433), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(100), "d", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(17533), "r", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(-17433), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(100), "d", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(-1743300), "r", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(-17433), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(100), "d", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(-174), "r", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(-17433), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(100), "d", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(-33), "r", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(-17433), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(100), "d", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "r", aliasMap, currentCfe);        // top * 0 = 0
    ...
    public void testIntBitOps() {
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "one", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "zero", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "allZeros", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "b", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "r", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(1), "one", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "zero", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(-1), "allZeros", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "b", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "r", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "zero", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(-1), "allZeros", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "r", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(-1), "allZeros", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(13), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0), "r", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(13), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0x7E6FC29D), "r", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(13), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(-1), "r", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(13), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(13), "r", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(13), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0xFFFFFFF2), "r", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(13), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0x81903D6F), "r", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(13), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0xF9BF0A40), "r", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(13), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0xF8520000), "r", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(13), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0xF37E1480), "r", aliasMap, currentCfe);       // Java-specific shift
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(13), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0x1F9BF0A4), "r", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(13), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0x0003F37E), "r", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(13), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0x0FCDF852), "r", aliasMap, currentCfe);      // Java-specific shift
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(-13), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0x3FFFFFFC), "r", aliasMap, currentCfe);
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(-13), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0x1FFF), "r", aliasMap, currentCfe);       // Java-specific shift
        ...
        TestUtils.assertLocalValue(TestUtils.getIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(-13), "c", aliasMap, currentCfe);
        TestUtils.assertLocalValue(TestUtils.getIntValue(0x1FFFFFFE), "r", aliasMap, currentCfe);       // Java-specific shift
