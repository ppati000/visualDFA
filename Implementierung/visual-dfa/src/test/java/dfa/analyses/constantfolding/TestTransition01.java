...
public class TestTransition01 {
    ...
    public void testAllConstant() {
        ...
        tu.assertLocalValue(tu.getCfIntValue(0), "one", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "x", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "y", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "z", aliasMap, currentCfe);
        ...
        currentCfe = cfe02;
        tu.assertLocalValue(tu.getCfIntValue(1), "one", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "x", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "y", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "z", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(1), "one", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "x", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(4), "y", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "z", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(0), "x", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(4), "y", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(4), "z", aliasMap, currentCfe);
        
        ConstantFoldingElement cfe06 = cfTransition.transition(cfe05, units.get(5));
        currentCfe = cfe06;
        tu.assertLocalValue(tu.getCfIntValue(1), "one", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(16), "x", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(4), "y", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(4), "z", aliasMap, currentCfe);
    ...
    public void testAllConstantConflict() {
        ...
        tu.assertLocalValue(tu.getCfIntValue(1), "one", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(17), "x", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "y", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "z", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(1), "one", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(1), "x", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "y", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "z", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(1), "one", aliasMap, currentCfe);
        tu.assertLocalValue(Value.getTop(), "x", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "y", aliasMap, currentCfe);        // here 0 * TOP should be 0
        tu.assertLocalValue(tu.getCfIntValue(0), "z", aliasMap, currentCfe);
    ...
    public void testNonConstant() {
        ...
        ConstantFoldingElement currentCfe = initInStateStartBlock;
        tu.assertLocalValue(tu.getCfIntValue(0), "p", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "one", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "x", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "y", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "$i0", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(Value.getTop(), "x", aliasMap, currentCfe);      
        tu.assertLocalValue(tu.getCfIntValue(0), "y", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "$i0", aliasMap, currentCfe);      // 0 * TOP = 0
        ...
        tu.assertLocalValue(tu.getCfIntValue(1), "one", aliasMap, currentCfe);
        tu.assertLocalValue(Value.getTop(), "x", aliasMap, currentCfe);      
        tu.assertLocalValue(tu.getCfIntValue(5), "y", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "$i0", aliasMap, currentCfe);
    ...
    public void testIntArithmetic() {
        ...
        ConstantFoldingElement currentCfe = initInStateStartBlock;
        tu.assertLocalValue(tu.getCfIntValue(0), "top", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "one", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "zero", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "d", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "r", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(1), "one", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "zero", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(-17433), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "d", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "r", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(0), "zero", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(-17433), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(100), "d", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "r", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(-17433), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(100), "d", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(-17333), "r", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(-17433), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(100), "d", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(17533), "r", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(-17433), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(100), "d", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(-1743300), "r", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(-17433), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(100), "d", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(-174), "r", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(-17433), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(100), "d", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(-33), "r", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(-17433), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(100), "d", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "r", aliasMap, currentCfe);        // top * 0 = 0
    ...
    public void testIntBitOps() {
        ...
        tu.assertLocalValue(tu.getCfIntValue(0), "one", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "zero", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "allOnes", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "b", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "r", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(1), "one", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "zero", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(-1), "allOnes", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "b", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "r", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(0), "zero", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(-1), "allOnes", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "r", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(-1), "allOnes", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(13), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0), "r", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(13), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0x7E6FC29D), "r", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(13), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(-1), "r", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(13), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(13), "r", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(13), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0xFFFFFFF2), "r", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(13), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0x81903D6F), "r", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(13), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0xF9BF0A40), "r", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(13), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0xF8520000), "r", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(13), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0xF37E1480), "r", aliasMap, currentCfe);       // Java-specific shift
        ...
        tu.assertLocalValue(tu.getCfIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(13), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0x1F9BF0A4), "r", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(13), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0x0003F37E), "r", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(13), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0x0FCDF852), "r", aliasMap, currentCfe);      // Java-specific shift
        ...
        tu.assertLocalValue(tu.getCfIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(-13), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0x3FFFFFFC), "r", aliasMap, currentCfe);
        ...
        tu.assertLocalValue(tu.getCfIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(-13), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0x1FFF), "r", aliasMap, currentCfe);       // Java-specific shift
        ...
        tu.assertLocalValue(tu.getCfIntValue(0x7E6FC290), "b", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(-13), "c", aliasMap, currentCfe);
        tu.assertLocalValue(tu.getCfIntValue(0x1FFFFFFE), "r", aliasMap, currentCfe);       // Java-specific shift
