...
\criteriumOptional{Erweitertes Java-Subset 1 - Priorität 1}{crt:extendedSubset1o}
...
\criteriumOptional{Erweitertes Java-Subset 2 - Priorität 2}{crt:extendedSubset2o}
Das Programm kann Java-Code einlesen und verarbeiten, wenn dieser folgende Operatoren und Konstrukte beinhaltet:
...
\criteriumOptional{Erweitertes Java-Subset 3 - Priorität 2}{crt:extendedSubset3o}
Das Programm kann Java-Code einlesen und verarbeiten, wenn dieser folgende Operatoren und Konstrukte beinhaltet:

Zuweisungen: +=, -=, *=, /=, \% =

\criteriumOptional{Zeilenangabe bei Fehlermeldungen - Priorität 2}{crt:lineNmbrErrorO}
...
\criteriumOptional{Analyse einzelner Zeilen innerhalb der Knoten - Priorität 1}{crt:lineAnalysisO}
...
\criteriumOptional{Einlesen von Code aus .java Datei - Priorität 3}{crt:CodeInputExto}
...
\criteriumOptional{Speichern in .java Datei - Priorität 3}{crt:saveO}
...
\criteriumOptional{Weitere Datenflussanalysearten - Priorität 2}{crt:DFAArtenO}
...
\criteriumOptional{Färbung des Graphen - Priorität 1}{crt:HighlightingO}
...
\criteriumOptional{Exportieren des Graphen als Bild-Datei - Priorität 3}{crt:exportPicO}
...
\criteriumOptional{\glqq Speichern?\grqq -Meldung vor schließen - Priorität 3}{crt:unsavedChangesO}
...
\criteriumOptional{\glqq Ungespeicherte Änderungen\grqq -Meldung bei Laden einer neuen Datei - Priorität 3}{crt:loadUnsavedO}
